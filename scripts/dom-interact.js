    ...
    try {
        ...
        data.forEach((category, index) => {
          ...
          button.className =
            currentCategoryIdx === index
              ? "btn big dark select-btn"
              : "btn big white select-btn";
          ...
          detailsElement.innerHTML = `
            <summary class="flex justify-between items-center">
              ...
              <div class="flex items-center justify-between w-[50%] max-md:w-full">
                <h1 class="text-[30px] max-w-[350px] max-lg:text-[25px] max-sm:text-[16px] max-sm:max-w-[200px]">${questionText(
                  details
                )}</h1>
               <div>
            ...
            <div class="content flex justify-between items-center">
              ...
              <div class="w-[50%] max-md:w-full">
                <p class="max-w-[430px] max-md:w-full max-sm:text-[12px]">${answerText(
                  details
                )}</p>
              </div>
            </div>
      ...
      const updateButtons = (data) => {
        ...
        buttons.forEach((button, index) => {
          button.className =
            currentCategoryIdx === index ? "btn big dark" : "btn big white";
        });
      };
      ...
      console.log("error from dom interact", err);
      reject(err);
    }
  });
};
