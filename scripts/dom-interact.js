const faqData = [
  {
    ...
    items: [
      ...
      {
        question_uz:
          "Xodimlar uchun qanday darajadagi kirish huquqlari mavjud?",
  ...
  {
    name_uz: "Restarant uchun",
    name_ru: "Для рестаранов",
    name_en: "For Restaurants",
    items: [
      {
  ...
  {
    name_uz: "Ishchilar uchun",
    name_ru: "Для работникам",
    name_en: "For Staff",
    items: [
      {
        question_uz:
