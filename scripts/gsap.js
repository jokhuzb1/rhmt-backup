    ...
    try {
      ...
      function starLoader() {
        ...
        function updateCounter() {
          ...
          currentValue = 100; //Math.floor(Math.random() * 10) + 1;
      ...
      function applyPhoneAnimation() {
        ...
        timeline.fromTo(
          phoneElement,
          { left: "-100%", autoAlpha: 1, position: "fixed" },
          {
            left: "42%",
            position: "fixed",
            top: "50%",
              ...
              onupdate: (self) => {
                ...
                imgElements.forEach((img, index) => {
                  ...
                  gsap.to(img, {
                    ...
                    visibility: gsap.utils.interpolate(
                      "hidden",
                      "visible",
                      progress
                    ),
                    right: gsap.utils.interpolate(
                      startLeft,
                      endRight,
                      progress
                    ),
      ...
      gsap.to(phoneItems, {
        ...
        scrollTrigger: {
          ...
          snap: 1 / (phoneItems.length - 1),
            ...
            "+=" +
            (document.querySelector(".horizontal-scroll").offsetWidth + 200),
        },
      });
      ...
      gsap.to(advantagesItem, {
        ...
        scrollTrigger: {
          ...
          snap: 1 / (advantagesItem.length - 1),
            ...
            "+=" +
            (document.querySelector(".advantages-scroll").offsetWidth + 200),
        },
      });
      ...
      function applyGSAPAnimations() {
        ...
        const PosSystemText = document.querySelector(
          ".section-with-ellipse h2"
        );
        const posSystemToDown = document.querySelector(
          ".pos-system-section-to-down-button"
        );
        //
        ...
        PosSystemText.innerHTML = posSystemWord
          .map((word) => `<span class="pos-system-text-word">${word}</span>`)
          .join(" ");

        const PoSystemTextSpan = document.querySelectorAll(
        ...
        gsap.fromTo(
          ...
          {
            className:
              "w-[50%] pos-system-right-content max-lg:!w-[100%] active",
            scrollTrigger: {
              trigger: sectionWithEllipse,
              start: "60% bottom",
              end: "bottom top",
        ...
        const partnersSectionTitle = document.querySelector(
        ...
        const ourPartnersTitle2 = document.querySelector(
          ".our-partners-title-2"
        );

        const partnersWord = PartnersTitle.innerText.split(" ");

        PartnersTitle.innerHTML = partnersWord
          .map((word) => `<span class="partner-text-word">${word}</span>`)
          .join(" ");

        const PartnersTextSpan =
        ...
        gsap.fromTo(
          ...
          {
            className:
              "mt-[450px] z-[5] relative max-md:mt-[100px] faq-section",
          },
          {
            className:
        ...
        const becomeValuedPartner = document.querySelector(
          ".become-valued-partner"
        );
        const contactSection = document.querySelector(".contact-section");

        if (becomeValuedPartner) {
          const becomeValuedPartnerWords =
            becomeValuedPartner && becomeValuedPartner.innerText.split(" ");
          becomeValuedPartner.innerHTML =
            becomeValuedPartnerWords &&
            becomeValuedPartnerWords
              .map(
                (word) =>
                  `<span class="become-valued-partner-word">${word}</span>`
              )
              .join(" ");
        }

        const becomeValuedPartnerSpan = document.querySelectorAll(
          ".become-valued-partner-word"
        );
        if (becomeValuedPartnerSpan && contactSection) {
          gsap.fromTo(
