  ...
  return new Promise((resolve, reject) => {
    ...
    if (navbar) {
      navbar.innerHTML = html`
        <div class="absolute w-full top-0 left-0 navbar z-[200]">
          <div class="container">
            <div
              class="flex justify-between items-start mt-[37px] max-md:mt-[20px]"
            >
        ...
        <div id="menu" class="main-menu overflow-hidden fixed z-[200]">
