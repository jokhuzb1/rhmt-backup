        ...
        <div>
          <div class="pos-system-section">
            <div class="h-[100vh]">
              ...
              <!--      <div class="flex justify-center w-full sticky bottom-[20px] pos-system-section-to-down-button">-->
              <!--        <div class="z-[200] relative">-->
              <!--          <button class="btn icon-btn !min-w-[40px] !p-0">-->
              <!--            <img-->
              ...
              <div class="flex justify-between max-lg:justify-center">
                ...
                <div class="w-[50%] pos-system-right-content max-lg:!w-[100%]">
                  ...
                  <div class="max-sm:flex max-sm:justify-center">
                    <h2
                      class="text-[50px] mt-[30px] max-lg:text-center max-md:text-[35px] max-sm:text-[25px] max-sm:max-w-[235px]"
