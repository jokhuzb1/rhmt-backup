        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 ">
          <div class="video-section col-span-1 relative">
            ...
            >
              ...
              <div  data-key="howItWorksBusinessScan" style="color:white;" class="overlay-text text-top-left ">
                Scan QR-code
              </div>
              ...
              <div style="color:white;" class="overlay-text text-bottom-left">
                <h2 data-key="howItWorksBusinessGuest">Guest scans the QR code</h2>
              </div>
              ...
              <div data-key="howItWorksBusinessMenu" style="color:white;" class="overlay-text text-top-left">
                Menu
              </div>
              <div style="color:white;" class="overlay-text text-top-right">
                02
              ...
              <div style="color:white;" class="overlay-text text-bottom-left">
                <h2 data-key="howItWorksBusinessReviewing">Reviewing the menu and form an order</h2>
              </div>
              <div style="color:white;" class="overlay-text text-bottom-right">
              ...
              <div data-key="howItWorksBusinessPay" style="color:white;" class="overlay-text text-top-left">
              ...
              <div style="color:white;" class="overlay-text text-bottom-left">
                <h2 data-key="howItWorksBusinessUpon">Upon completion, the bill and tip are paid.</h2>
              </div>
              <div style="color:white;" class="overlay-text text-bottom-right">
                <p>
              ...
              <div data-key="howItWorksBusinessLeave" style="color:white;" class="overlay-text text-top-left">
                Leave review
              </div>
              <div style="color:white;" class="overlay-text text-top-right">
                04
              ...
              <div style="color:white;" class="overlay-text text-bottom-left">
                <h2 data-key="howItWorksBusinessWaiter">The waiter may offer to leave a review.</h2>
              </div>
              <div style="color:white;" class="overlay-text text-bottom-right">
                <p data-key="howItWorksBusinessYou">You can leave a review upon the waiter's request.</p>
              </div>
            </div>
          </div>
        </div>
