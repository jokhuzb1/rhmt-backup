      ...
      header.innerHTML = html`
        ...
        <div class="container showcase-section relative">
          ...
          >
            ...
            >
              <h1
                class="text-[58px] max-w-[600px] responsive-text z-[2] header-text  !text-center lg:!text-left w-full max-lg:!max-w-[450px] max-lg:mr-0 max-md:text-[40px] max-sm:text-[30px]"
